import json, os, sys
source = json.load(open(os.path.join(sys.path[0], 'data/xptypes.json')))
evolution = json.load(open(os.path.join(sys.path[0], 'data/evolution.json')))
catch = json.load(open(os.path.join(sys.path[0], 'data/catchrates.json')))
open(os.path.join(sys.path[0], 'data/stats.json'), 'w').write('')
